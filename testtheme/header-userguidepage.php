                    ...
                    <!-- Nav -->
                        <nav id="nav">
                            <ul>
                                ...
                                <li class="current_page_item"><a href="http://localhost/wordpress/user-guide-page/">档文</a></li>
...
<div class="row above">
<center>
<img src="http://localhost/wordpress/wp-content/uploads/2017/06/webwxgetmsgimg-e1497438989695.jpg" class="backgroundimage"/>
</center>
...
<form action="" method="post" class="formdown">
