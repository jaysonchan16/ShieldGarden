                            ...
                            <ul>
                              <li><a href="http://localhost/wordpress/user-bet/">下注</a></li>
                                ...
                                <li>
                                    <a href="">下线</a>
                                    <ul>
                                      	<li class="current_page_item"><a href="http://localhost/wordpress/second-sub-dealer-profile/">报告</a></li>
...
while ($row = mysqli_fetch_assoc($result)) {
    echo "<tr>
        <td>".$count."</td>
        <td><a href='http://localhost/wordpress/subdeaslbet/?usrnm=".$row["username"]."'>".$row["username"]."</a></td>
        <td>".$row["now"]."</td>
        <td>".$row["last"]."</td>
        <td>".$row["nameDt"]."</td>
        <td>".$row["phDt"]."</td>
