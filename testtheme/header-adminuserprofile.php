...
<li> <a href="https://www.ltttry8899.com/admin-4d-results/" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu">4D Result<span class="fa arrow"></span> </span></a>
        ...
        <li><a href="#" class="waves-effect active"><i data-icon=")" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Profile<span class="fa arrow"></span></span></a>
          <ul class="nav nav-second-level">
            <li><a href="https://www.ltttry8899.com/admin-4d-results/" class="active">User Profile</a></li>
...
$query = "SELECT * FROM users WHERE userType = 'P'";
...
while ($row = mysqli_fetch_assoc($result)) {
    echo "<tbody><tr>
        <td>".$count."</td>
        <td><a href='https://www.ltttry8899.com/adbethistory/?usrnm=".$row["username"]."'>".$row["username"]."</a></td>
        <td>".$row["now"]."</td>
        <td>".$row["last"]."</td>
        <td>".$row["nameDt"]."</td>
        <td>".$row["phDt"]."</td>
