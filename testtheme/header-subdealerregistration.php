...
<div class="col-md-6">
	<div class="white-box" style="border: green 5px solid;">
        ...
        <h3><input type="hidden" name="subdealer1" value="<?php echo $user ?>"></h3>
				...
				<label class="control-label col-sm-3" for="username">用户名称:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" name="selectusr" value="<?php echo $row ['Name'];?>" id="selectusr">
					</div>
				</div>
				<div class="form-group m-b-0">
                <div class="col-sm-offset-3 col-sm-9">
			...
			<form class="form-horizontal" action="http://localhost/wordpress/dealer-store-dealer-registration/" method="post">
				...
				<label class="control-label col-sm-3" for="username">用户名称:</label>
					<div class="col-sm-5">
						<input type="text" name="userupdate" id="userupdate" value=""  class="form-control" disabled>
					</div>
				</div>
				...
				<label class="control-label col-sm-3" for="password">密码:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" name="passupdate" id="passupdate" disabled>
					</div>
				</div>
				<div class="form-group">
				<label class="control-label col-sm-3" for="phone">手机号码:</label>
					<div class="col-sm-5">
						 <label class="control-label col-sm-6" id="phone" for="phone">
							<select class="form-control" id="ctCodeup" name="ctCodeup" disabled>
							 	<option name="firsteightysix" value="+86">+86</option>
          			<option name="firstsixty" value="+60" selected="selected">+60</option>	
							</select></label>
							<input type="text" style="border-radius: 4px; margin-top: 7px;" value="" class="control-label col-sm-6" id="phnumup" name="phnumup" disabled>		
					</div>
				</div>
				<center><h3 style="color: red;" class="box-title m-b-0">(可选择)</h3></center>
				<div class="form-group">
            	<label class="control-label col-sm-3" for="backacc">银行账号:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="bankaccup" name="bankaccup" value="" disabled>
					</div>
				</div>
				<div class="form-group">
				<label class="control-label col-sm-3" for="backnme">银行名称:</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="banknameup" name="banknameup" value="" disabled>
					</div>
				</div>
				<div class="form-group">
                <label class="control-label col-sm-3" for="stat">状态:</label>
                <div class="col-sm-5">
                  <select class="form-control" id="statup" name="statup" disabled>
				...
				<input id="staclr" class="control-label col-sm-6" type="textbox" style="border-radius: 4px; margin-top: 7px;" readonly><p style="margin-top: 8px;"></p>
                </div>
              </div>
			<h3><input type="hidden" name="subdealer" value="<?php echo $user ?>"></h3>
			<div class="form-group m-b-0">
                <div class="col-sm-offset-3 col-sm-9">
					<input type="submit" name="update" id="update" class="btn btn-info waves-effect waves-light m-t-10" value="存储" disabled/>
                </div>
              </div>
</form>
</div>
