...
.container-fluid{
  ...
  <nav class="navbar navbar-inverse">
	...
	<form action="https://www.ltttry8899.com/2-1-admin-process/" method="post">
  	<div class="login-form">
	<div style="background:#000;color:#fff;padding:10px;text-align:center">Admin Login</div>
	<input type="text" name="admin" id="usrid" placeholder="Username" style="margin:30px 0 0 0;border-radius:4px 4px 0 0" />
