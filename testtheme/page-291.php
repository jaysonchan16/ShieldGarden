...
.container-fluid{
  ...
  <nav class="navbar navbar-inverse">
	...
	<form action="https://www.ltttry8899.com/mainadprocess/" method="post">
  	<div class="login-form">
	<div style="background:#000;color:#fff;padding:10px;text-align:center">Main Admin Login</div>
	<input type="text" name="mainadmin" id="usrid" placeholder="Username" style="margin:30px 0 0 0;border-radius:4px 4px 0 0" />
	<input type="password" name="mainpass" id="usrpw" placeholder="Password" style="margin:0 0 30px 0;border-radius:0 0 4px 4px" />
    </div>
    <div>
