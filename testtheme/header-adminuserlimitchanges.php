...
if(isset($_POST['select']))
{
  ...
  if(mysqli_query($conn,$query))
  {
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<script type="text/javascript">document.getElementById("myDIV").style.display = "block";</script>';
  }
...
<li> <a href="https://www.ltttry8899.com/admin-4d-results/" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu">4D Result<span class="fa arrow"></span> </span></a>
        ...
        <li><a href="#" class="waves-effect"><i data-icon=")" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Profile<span class="fa arrow"></span></span></a>
          <ul class="nav nav-second-level">
            <li><a href="https://www.ltttry8899.com/admin-user-profile/">User Profile</a></li>
            <li><a href="https://www.ltttry8899.com/admin-dealer-profile/">Dealer Profile</a></li>
           </ul>
        </li>
        ...
        <li> <a href="#" class="waves-effect active"><i data-icon="O" class="linea-icon linea-software fa-fw"></i> <span class="hide-menu">Limit<span class="fa arrow"></span></span></a>
          <ul class="nav nav-second-level">
            <li><a href="https://www.ltttry8899.com/admin-bet-no-limit/">Bet No. Limit</a></li>
			       <li><a href="https://www.ltttry8899.com/admin-user-limit-changes/" class="active">User Limit</a></li>
            <li><a href="https://www.ltttry8899.com/admin-user-payment/">Payment</a></li>
          </ul>
        </li>
 		<li> <a href="https://www.ltttry8899.com/admin-update-winrate/" class="waves-effect"><i data-icon="&#xe008;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Win Rate<span class="fa arrow"></span></span></a>
        </li>
</ul>
    </div>
  </div>
   ...
   $("#search").click(function(e)
    ...
    $("#search").click(function()
    {
      ...
      $.ajax({
        ...
        dataType: "json",
        url:"<?php bloginfo('template_directory');?>/header-adminstoreuserlimitchanges",
       // url: "http://localhost/wordpress/admin-store-user-limit-changes/",
        data: {
          name:name
        },
		...
		<div class="row">
          ...
          <div class="white-box">
                ...
                <div class="col-sm-5">
                  ...
                  <input type="submit" class="btn btn-success waves-effect waves-light m-r-10"  id="search" name="select" value="Search"></center>
                </div>
                </div>
             </form>
          </div>
          <div class="col-sm-12" >
            <div class="white-box" id="showwhite">
              <h2>Set user available limit</h2>   
                <form class="form-horizontal" action="" method="post">
                  <div class="form-group">
                    <label for="UserName" class="col-sm-3 control-label">Username:</label>
                      <div class="col-sm-9">
                        <input id="userupdate" class="form-control" type="text" name="userupdate" id="userupdate" value="" disabled>
                      </div>
                  </div>
                  <div class="form-group">
                    <label for="Before" class="col-sm-3 control-label">Before:</label>
                      <div class="col-sm-9">
                        <input id="before" class="form-control" type="text" name="before" value="" disabled>
                      </div>
                  </div>
                  <div class="form-group">
                    <label for="After" class="col-sm-3 control-label">After:</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="after" placeholder="Update" disabled>
                      </div>
                  </div>
                  <center><button style="width: 10%;height: 15%;" type="submit" class="btn btn-success waves-effect waves-light m-r-10" name="update" id="update" value="Save" disabled>Save</button></center>
                </form>
            </div>
      </div>
   </div>
