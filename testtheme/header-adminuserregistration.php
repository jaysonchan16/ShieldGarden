...
<li> <a href="http://localhost/wordpress/admin-user-registration/" class="waves-effect active"><i class="linea-icon linea-basic fa-fw" data-icon="/"></i> <span class="hide-menu">Registration<span class="fa arrow"></span> </span></a>
        </li>
          ...
          <h3 class="box-title m-b-0">Register</h3>
            <form action="" class="form-horizontal" method="post">
              ...
              <label for="Password" class="col-sm-3 control-label">Retype Password:</label>
                <div class="col-sm-9">
                  <input type="password" class="form-control" id="inputRetypePassword" name="retypepassword" placeholder="Enter password here">
                </div>
              </div>
              <div class="form-group">
              ...
              <label for="Dealer:" class="col-sm-3 control-label">Dealer: (Please check here) => </label>
                <div class="col-sm-9">
                  <div class="checkbox checkbox-success">
                      <input id="checkbox1" name="dealer" value="dealer" type="checkbox"></div>
                </div>
              </div> 
          ...
          <h3 class="box-title m-b-0" style="color: red;">Maintenance</h3>
            <form action="http://localhost/wordpress/admin-store-registration/" class="form-horizontal" method="post">
             <div class="form-group">
              <label for="username" class="col-sm-3 control-label">User Name:</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="selectusr" name="selectuser" placeholder="Please select username">
                </div>
              </div>
              ...
              <label for="username" class="col-sm-3 control-label">User Name:</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="userupdate" id="userupdate" placeholder="Enter User Name" value="" disabled>
                </div>
              </div>
              ...
              <label for="Password" class="col-sm-3 control-label">Password:</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="passupdate" id="passupdate" placeholder="Update" disabled>
                </div>
              </div>
              <div class="form-group">
              <label for="Password" class="col-sm-3 control-label">Confirm Password:</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="passupdate" id="confirmpassupdate" placeholder="Update" disabled>
                </div>
              </div>
              <div class="form-group">
              <label for="Phone" class="col-sm-3 control-label">Phone No:</label>
                <div class="col-sm-5">
                  <label class="control-label col-sm-6" id="phone" for="phone">
                    <select class="form-control" name="phoneFront" disabled>
                      <option name="eightysix" value="+86">+86</option>
                      <option name="sixty" value="+60" selected="selected">+60</option>  
                    </select></label>
                <input type="text" style="border-radius: 4px; margin-top: 7px;" class="control-label col-sm-6" name="phoneEnd" placeholder="Update" value="" disabled>    
              </div>
            </div>
            <h3 style="color: red;">(Optional)</h3>
             <div class="form-group">
              <label for="Bank acc" class="col-sm-3 control-label">Bank Acc:</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="inputBankAcc" name="bankaccup" placeholder="Update" value="" disabled>
                </div>
              </div> 
              <div class="form-group">
              <label for="Bank Name" class="col-sm-3 control-label">Bank Name:</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="inputBankName" name="banknameup" placeholder="Update" value="" disabled>
                </div>
              </div> 
             <div class="form-group">
                <label class="control-label col-sm-3" for="Status">Status:</label>
                <div class="col-sm-9">
                  <select class="form-control" name="statup" disabled>
              ...
              <center><button style="height: 55px; width: 105px;" class="btn btn-success waves-effect waves-light m-r-10" type="submit" name="update" id="update" value="Save" disabled>Save</button></center>
            </form>
               </div>
           </div> 
