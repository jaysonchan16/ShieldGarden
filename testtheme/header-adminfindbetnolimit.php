...
<div id="page-wrapper">
  <div class="container-fluid">
                ...
                <form class="form-horizontal" action="" method="post">
                  <div class="form-group">
                    <label for="betsearch" class="col-sm-3 control-label">Search Bet No.:</label>
                      <div class="col-sm-9">
                        <input id="betsearch" class="form-control" type="number" name="betsrch" id="search" maxlength="4" disabled>
                        <input type="submit" class="btn btn-success waves-effect waves-light m-r-10" name="search" value="Search" disabled>
                      </div>
                  </div>
                  </form>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="betn" class="col-sm-3 control-label">Bet No.:</label>
                      <div class="col-sm-9">
                        <input id="betno" class="form-control" type="number" name="betnum" maxlength="4">
                      </div>
                  </div>
                  <div class="form-group">
                    <label for="beta" class="col-sm-3 control-label">Bet Amount:</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="read" value="<?php echo $betamt ?>" readonly>
                      </div>
                  </div>
                  <div class="form-group">
                    <label for="bet1" class="col-sm-3 control-label">Bet Limit:</label>
                      <div class="col-sm-9">
                        <input class="form-control" type="text" name="betlim" value="<?php echo $betlimit ?>" placeholder="Update">
                      </div>
                  </div>
      ...
      <div class="col-sm-12">
                   <div class="white-box">
                   <form class="form-horizontal" action="http://localhost/wordpress/6-0-2-update-limit/" method="post">
                  <div class="form-group">
                    <label for="betn" class="col-sm-3 control-label">Bet No.:</label>
                      <div class="col-sm-9">
                        <input id="read" name="betnumup[]" type="text" class="form-control" value="<?php echo $betno ?>" readonly>
                      </div>
                  </div>
                  <div class="form-group">
                    <label for="beta" class="col-sm-3 control-label">Bet Amount:</label>
                      <div class="col-sm-9">
                        <input id="read" type="text" class="form-control" value="<?php echo $betamt ?>" readonly>
                      </div>
                  </div>
                  <div class="form-group">
                    <label for="bet1" class="col-sm-3 control-label">Bet Limit:</label>
                      <div class="col-sm-9">
                        <input class="form-control" type="text" name="betlimup[]" value="<?php echo $betlimit ?>" placeholder="Update">
                      </div>
                  </div>
                  <center><input  type="submit" name="update" id="update" value="Save" class="btn btn-success waves-effect waves-light m-r-10"></center>
                </form>
            </div>
      </div>
<?php } else{} ?>
