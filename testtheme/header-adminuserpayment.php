...
<li> <a href="http://localhost/wordpress/admin-user-registration/" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="/"></i> <span class="hide-menu">Registration<span class="fa arrow"></span> </span></a>
        ...
        <li> <a href="#" class="waves-effect active"><i data-icon="O" class="linea-icon linea-software fa-fw"></i> <span class="hide-menu">Limit<span class="fa arrow"></span></span></a>
          <ul class="nav nav-second-level">
            ...
            <li><a href="http://localhost/wordpress/admin-user-payment/" class="active">Payment</a></li>
          </ul>
        </li>
  ...
  <div class="container-fluid">
		...
		<div class="row">
          ...
          <div class="white-box">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" nname="selectusr[]" id="selectusr" placeholder="Please select username"><br><center>
          ...
          <div class="col-sm-12">
            <div class="white-box">
              <h2>Set user available limit</h2>   
                <form class="form-horizontal" action="http://localhost/wordpress/5-9-payment-process/" method="post">
                  <div class="form-group">
                    <label for="username" class="col-sm-3 control-label">Username:</label>
                      <div class="col-sm-9">
                        <input class="form-control" type="text" name="userupdate" id="userupdate" value="<?php echo $usr ?>" readonly>
                      </div>
                  </div>
                  <div class="form-group">
                    <label for="limit" class="col-sm-3 control-label">Available Limit:</label>
                      <div class="col-sm-9">
                        <input class="form-control" type="text" name="avlim[]" value="<?php echo $limit ?>" readonly>
                      </div>
                  </div>
                  <div class="form-group">
                    <label for="balance" class="col-sm-3 control-label">Available Balance:</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="read" name="avbal[]" value="<?php echo $bal ?>" readonly>
                      </div>
                  </div>
                  <div class="form-group">
                    <label for="out" class="col-sm-3 control-label">Outstanding Balance:</label>
                      <div class="col-sm-9">
                        <input class="form-control" id="read" type="text" name="outbal[]" value="<?php echo $out ?>" readonly>
                      </div>
                  </div>
                <?php if($out == '0'){ ?>
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                  ...
                  <div class="form-group">
                    <label for="pay" class="col-sm-3 control-label">Pay amount:</label>
                      <div class="col-sm-9">
                        <input class="form-control" type="text" id="read" readonly>
                      </div>
                  </div>
                  <?php } elseif($out > '0'){ ?>
                   <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <label for="pay" class="col-sm-3 control-label">Pay amount:</label>
                      <div class="col-sm-9">
                        <input class="form-control" type="number" id="pay" name="pay[]" min="1" max="<?php echo $out ?>">
                      </div>
                  </div>
                  <?php } ?>  
                  <center><input type="submit" name="update" id="update" value="Pay" class="btn btn-success waves-effect waves-light m-r-10"></center>
                </form>
            </div>
      </div>
   </div>
