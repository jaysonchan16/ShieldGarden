...
<h2 style="color: red;">User Limit</h2>
...
<form action="https://www.ltttry8899.com/5-8-change-limit-process/" method="post">
...
<h3><label for="before">Before&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label><input id="read"  type="text" name="before[]" value="<?php echo $limit ?>" readonly></h3>
<h3><label for="after">After&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label><input type="text" name="after[]" placeholder="Update"></h3>
